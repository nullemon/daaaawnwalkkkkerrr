...
import type { Build, Court, Ending } from '@/payload-types'
...
export default async function Home({ params }: Props) {
  ...
  const [endings, quests, regions, mechanics, courts, items, perks, characters, enemies, builds, guides] =
    await Promise.all([
    getAll('endings', { game, depth: 0 }),
    getAll('quests', { game, depth: 0 }),
    getAll('regions', { game, depth: 0 }),
    getAll('mechanics', { game, depth: 0, sort: 'order' }),
    getAll('courts', { game, depth: 0 }),
    getAll('items', { game, depth: 0 }),
    getAll('perks', { game, depth: 0 }),
    getAll('characters', { game, depth: 0 }),
    getAll('enemies', { game, depth: 0 }),
    getAll('builds', { game, depth: 0 }),
    getAll('guides', { game, depth: 1, sort: '-updatedAt' }),
  ])
